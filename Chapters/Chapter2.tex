...
El módulo ESP32-S3-WROOM-1-N8R8 es una potente módulo de unidad de microcontrolador (MCU, \textit{Microcontroller Unit}) de doble núcleo que incorpora Wi-Fi y Bluetooth de baja energía (BLE, (\textit{Bluetooth Low Energy}) y tiene un amplio conjunto de periféricos. Sus especificaciones técnicas más relevantes se detallan en la tabla \ref{tab:devkit_specs}.
